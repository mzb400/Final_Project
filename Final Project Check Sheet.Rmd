...
(A) .Rmd Line numbers where at least two different data sources are imported: Lines 18,23,25,27,29 


(B) .Rmd Line numbers for inspecting data intake: Lines 21,31,33,35 
...
(A) .Rmd Line number(s) for general data wrangling: Lines 56,57,59,60,70,74,75,157


(B) .Rmd Line number(s) for a join operation: Line 94 is Join Operation. Merges are at lines 77,80.


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): Line 65 is spread(). Lines 97,171,175 are pivot_longer().


(D) .Rmd Line number(s) for use of regular expressions: 


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: Lines 60,170,171


(F) .Rmd Line number(s) for use of user-defined functions: Lines 54,63,68,72,77,80,94,95,116,123,136,142,154,155,168,188,192,196,197
...
(A) .Rmd Line number(s) for use of mulitple different geoms:  Lines 104-111, 116-127, 136-146, 154-160, 168-179, 200-204.

(B) .Rmd Line number(s) for use of multiple aesthetics:  Lines 108-109, 118-119, 125-126, 138-139, 144-145, 160, 180, 202, 205

(C) .Rmd Line number(s) for use of layered graphics: Line 180
